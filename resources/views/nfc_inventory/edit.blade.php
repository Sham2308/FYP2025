    ...
    <div class="max-w-4xl mx-auto mt-6 bg-white p-6 rounded-lg border">
        ...
        <form method="POST" action="{{ route('items.update', $item->asset_id) }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    <label class="block text-sm font-medium mb-1">Item ID (UID)</label>
                    <input name="item_id" value="{{ old('item_id', $item->item_id) }}" class="w-full border rounded p-2" readonly>      
                </div>
