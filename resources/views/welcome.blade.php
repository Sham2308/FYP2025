...
<head>
  ...
  <title>{{ config('app.name', 'TapNBorrow') }} — Welcome</title>
  <link rel="icon" type="image/png" href="{{ asset('images/tapnborrow-logo.png') }}">
  ...
  <style>
    ...
    * { box-sizing:border-box; }
    ...
    .card {
      ...
      border-radius:20px; padding:32px; box-shadow: 0 10px 30px rgba(0,0,0,.25);
      display:flex; flex-direction:column; align-items:center; gap:16px; text-align:center;
    }

    /* Bigger, centered logo (responsive) */
    .logo {
      display:block; width:auto;
      height:clamp(96px, 12vh, 160px);   /* min 96px, usually ~12% of viewport height, max 160px */
      margin: 4px auto 6px;
    }
...
<body>
  <main class="wrap">
    <section class="card">
      ...
      <img src="{{ asset('images/tapnborrow-logo.png') }}" alt="TapNBorrow" class="logo">
