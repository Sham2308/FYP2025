...
<div class="wrap">
    ...
    <div class="card borrow-card" style="flex:0.6;">
        ...
        <form action="{{ route('borrow.store') }}" method="POST">
            ...
            <div id="items-container">
                <div class="row item-row" style="margin-top:10px;">
                    <div style="display:flex; gap:6px; flex:1;">
                        <input class="item_uid" name="items[0][uid]" type="text" placeholder="Item UID" required readonly>
            ...
            <button type="button" class="btn btn-info" id="addItemBtn" style="margin-top:10px;">+ Add Another Item</button>
...
document.getElementById('addItemBtn').addEventListener('click', () => {
    ...
    newRow.innerHTML = `
        <div style="display:flex; gap:6px; flex:1;">
            <input class="item_uid" name="items[${itemIndex}][uid]" type="text" placeholder="Item UID" required readonly>
            <button type="button" class="btn btn-success scanStickerBtn">Scan Sticker</button>
        </div>
...
document.addEventListener('click', async (e) => {
    if (e.target.classList.contains('scanStickerBtn')) {
        ...
        try {
            ...
            assetInput.value = item.asset_id || '';
